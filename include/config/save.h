...
#define FREE_MYSTERY_EVENT_BUFFERS          TRUE    // Frees up ramScript (1104 bytes). - REQUIRED FOR DAYDREAM
...
#define FREE_ENIGMA_BERRY                   TRUE    // Frees up E-Reader Enigma Berry data (52 bytes). - REQUIRED FOR DAYDREAM
#define FREE_LINK_BATTLE_RECORDS            TRUE    // Frees up link battle record data (88 bytes). - REQUIRED FOR DAYDREAM
